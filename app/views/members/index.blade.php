...
@yield('content')
	...
	<div id="lu_content">
		...
		<div class="lu_content_box lu_clear">
			<div class="lu_content_main lu_clear">
				...
				<div class="lu_resumes clear">
					<div class="lu_resumes_user lu_clear">
						...
						<div class="lu_userMessage">
							...
							<p class="lu_te userMessage_name lu_left">夏米斯丁艾合麦提·阿布都米吉提</p>
							<p class="lu_te userMessage_p lu_userMessage_school lu_left">黑龙江工程学院</p>
			...
			<div class="lu_content_right">
				{{ HTML::image('assets/images/user_1.png') }}
