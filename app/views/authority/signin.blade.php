...
@yield('content')
	...
	<div id="login_wrap">
		...
		<a id="login_index" href="{{ route('home') }}">{{ Lang::get('navigation.index') }}</a>
		<a id="login_tab" href="javascript:void(0);">{{ Lang::get('navigation.signup') }}</a>
			...
			<div id="login_main_wrap">
				<div id="login_main">
					...
					{{ Form::open(array(
						...
						<p class="signin_error" style="text-align: center;">
						...
						<ul class="login_form">
							...
							<li class="login_li">
								...
								<input type="password" name="password" class="signin_password" required="required" placeholder="{{ Lang::get('authority.password_input') }}">
							</li>
						</ul>
					...
					{{ Form::open(array(
						...
						<ul class="login_form">
							<li class="rgs_li">
								...
								<input type="email" name="signup_email" autofocus required="required" placeholder="{{ Lang::get('authority.email_input') }}">
							</li>
							<li class="rgs_li">
								<span>{{ Lang::get('authority.password') }}:</span>
