...
@yield('content')
	...
	<div id="login_wrap">
		...
		<a id="login_tab" href="javascript:void(0);">注册</a>
				...
				<div id="login_main">
					...
					{{ Form::open(array(
						...
						<ul class="login_form">
							...
							<li class="login_li">
								<span>密码:</span>
								<input type="password" name="password" class="signin_password" required="required" placeholder="您的密码">
							</li>
						</ul>
				...
				<div id="rgs_main">
					...
					{{ Form::open(array(
						...
						<ul class="login_form">
							<li class="rgs_li">
								<span>邮箱:</span>
								<input type="email" name="signup_email" autofocus required="required" placeholder="请输入您的常用电子邮箱">
							</li>
							<li class="rgs_li">
								<span>密码:</span>
