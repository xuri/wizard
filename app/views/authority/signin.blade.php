				...
				<div id="rgs_main">
					...
					{{ Form::open(array(
						...
						<ul class="login_form">
							<li class="rgs_li">
								<span>邮箱:</span>
								<input type="email" name="username" autofocus required="required" placeholder="请输入您的常用电子邮箱">
							</li>
							<li class="rgs_li">
								<span>密码:</span>
								<input type="password" name="password" required="required" placeholder="6-16位字母或数字的组合">
							...
							<li class="rgs_li">
								<span>重复密码:</span>
								<input type="password" name="repassword" required="required" placeholder="确认你的密码">
							</li>
						</ul>
						<div class="login_clause">
							<input class="login_check" type="checkbox" name="checkbox" checked >
