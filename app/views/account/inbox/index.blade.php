						...
						<ul class="clear">
							...
							{{ Form::open(array(
								...
								@elseif($data->status == 4)
									...
									{{ Lang::get('account/chat.lock_you') }}</a>
								@else
								...
								@endif
								@if($data->status == 0)
									<a href="{{ route('members.show', $user->id) }}" class="button-wait">{{ Lang::get('account/chat.pending') }}</a>
								...
								<a href="javascript:void(0)" class="button-block">{{ Lang::get('account/chat.is_reject') }}</a>
								@elseif($data->status == 3)
								<a href="javascript:void(0)" class="button-block">{{ Lang::get('account/chat.is_lock') }}</a>
								@endif
								</div>
