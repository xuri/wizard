                        ...
                        <div class="panel-body">
                            <div class="row">
                                {{ Form::open(array(
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>用户ID：{{ $data->id }}， 注册来源：
                                                ...
                                                @if($data->email)
                                                <label>， 邮箱地址：<i class="fa fa-envelope-o"></i> {{ $data->email }}</label>
                                                @else
                                                <label>， 邮箱地址：<i class="fa fa-envelope-o"></i> 未设置</label>
                                                @endif
                                            </label>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>所在高校</label>
                                            <select class="form-control selectpicker input-light brad" data-live-search="true" id="school" name="school" onchange="setschool();" rel="{{ $data->school }}">
                                                <option value="">请选择</option>
                                        ...
                                        <div class="form-group">
                                            <label>所在省份</label>
                                            <select class="form-control" id="province" name="province" onchange="setprovince();" rel="{{ $data->province_id }}">
                                                <option value="">请选择</option>
                                        ...
                                        <div class="form-group">
                                            <label>薪资范围</label>
                                            <select class="form-control" id="salary" name="salary" onchange="setsalary();" rel="{{ $profile->salary }}">
                                        ...
                                        <a href="{{ route($resource.'.detail', $data->id) }}" class="btn btn-outline btn-primary">查看此用户的好友关系详情</a>
                                        <a href="{{ route($resource.'.notify', $data->id) }}" class="btn btn-outline btn-primary">向此用户推送系统通知</a>
                                    </div>
                                    {{-- /.col-lg-6 (nested) --}}
                                    <div class="col-lg-6">
                                    ...
                                    {{-- /.col-lg-6 (nested) --}}
                                    <button type="submit" class="btn btn-outline btn-success">保 存</button>
                                    <button type="reset" class="btn btn-default">重 置</button>
                                    <a href="{{ route($resource.'.chatdir', $data->id) }}" class="btn btn-default disabled">查看此用户的聊天记录存档</a>
                                {{ Form::close() }}
                            </div>
                            {{-- /.row (nested) --}}
                        </div>
