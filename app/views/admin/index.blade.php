    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">聘爱网 管理中心</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="index.html"><i class="fa fa-dashboard fa-fw"></i> 控制面板</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> 界面元素<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.list-group -->
                            <a href="#" class="btn btn-default btn-block">查看所有提醒</a>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
