...
<html>
<head>
	<title>{{ Lang::get('system.maintenance') }} | {{ Lang::get('navigation.pinai') }}</title>
					...
					<div class="panel-body">
						<div class="ibc" style="margin: 20px 0">
							<div class="ibc-content">
								{{ HTML::image('assets/images/503.png', '', array('width' => '200', 'height' => '200')) }}
							</div>
						</div>
						<div class="ibc" style="margin: 20px 0">
							<div class="ibc-content">
								<h1 class="bold">{{ Lang::get('system.maintenance') }}</h1>
							</div>
						</div>
						<p style="margin: 10px 44px; text-align: center; font-size: 14px;">{{ Lang::get('system.maintenance_text') }}</p>
					</div>
				</div>
			</div>
		</div>
