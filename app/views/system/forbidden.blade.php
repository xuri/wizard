...
<html>
<head>
	<title>{{ Lang::get('system.500') }} | {{ Lang::get('navigation.pinai') }}</title>
					...
					<div class="panel-body">
						<div class="ibc" style="margin: 20px 0">
							<div class="ibc-content">
								{{ HTML::image('assets/images/403.png', '', array('width' => '200', 'height' => '200')) }}
							</div>
						</div>
						<div class="ibc" style="margin: 20px 0">
							<div class="ibc-content">
								<h1 class="bold">{{ Lang::get('system.forbidden') }}</h1>
							</div>
						</div>
						<p style="margin: 10px 44px; text-align: center; font-size: 14px;">{{ Lang::get('system.forbidden_text') }}</p>
					</div>
				</div>
			</div>
		</div>
