    ...
    public function like($id)
    {
        ...
        switch ($status) {
            ...
            case 'reject' :
                ...
                $like->status   = 2;
                if ($like->save()) {
                    // Some user reject you like
                    Notification(4, Auth::user()->id, $id);
            ...
            case 'accept' :
                ...
                if ($like->save()) {
                    // Some user accept you like
                    $notification = Notification(3, Auth::user()->id, $id);
            ...
            case 'sender_block' :
                ...
                if ($like->save()) {
                    // Some user blocked you
                    Notification(5, Auth::user()->id, $id);
                    return Redirect::back()
                        ->withInput()
                        ->with('success', Lang::get('members/index.lock_success'));
                } else {
            ...
            case 'sender_recover' :
                ...
                $like->status   = 0;
                if ($like->save()) {
                    // Some user recover blocked you
                    Notification(10, Auth::user()->id, $id);
                    return Redirect::back()
                        ->withInput()
                        ->with('success', Lang::get('members/index.unlock_success'));
                } else {
